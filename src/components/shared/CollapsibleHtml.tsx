      ...
      {overflows && (
        <div className="relative mt-4 flex justify-center">
          <button
            ...
            className="flex items-center gap-2 rounded-full border border-gray-200 bg-white px-6 py-2.5 text-sm font-bold text-gray-700 shadow-sm transition hover:border-blue-400 hover:text-blue-600 hover:shadow-md"
          >
            {expanded
