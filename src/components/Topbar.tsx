              ...
              <div className="admin-card absolute right-0 top-[calc(100%+0.75rem)] z-50 w-80">
                ...
                <div className="bg-[#F8FAFC] px-5 py-5">
                  <div className="flex items-center gap-4">
                    <label className="group relative flex h-14 w-14 shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-full bg-[#0B0F19] text-lg font-black text-white shadow-sm">
                      {session?.user.avatarUrl ? (
                        <img src={session.user.avatarUrl} alt="" className="h-full w-full object-cover" />
                      ) : (
                        initials || 'AD'
