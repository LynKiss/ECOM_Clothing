    ...
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/45 px-4 py-6">
          ...
          >
            <div className="flex items-start justify-between gap-4 px-5 py-5 text-white md:px-7" style={{ background: '#0B0F19' }}>
              <div>
            ...
            <div className="border-b border-black/5 bg-[#F8FAFC] px-4 py-4 md:px-7">
              <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                ...
                <div className="flex gap-2 text-xs font-bold text-[#0B0F19]/70">
            ...
            <div className="min-h-0 flex-1 overflow-y-auto bg-[#F8FAFC] p-4 md:p-6">
              {loading ? (
                ...
                <div className="client-card flex flex-col items-center justify-center py-16 text-center">
                  <Gift size={48} className="mb-3 text-[#2563EB]/25" />
                  <h3 className="text-lg font-black text-[#0B0F19]">
  ...
  return (
    <article className="client-card overflow-hidden">
      <div className="grid grid-cols-[92px_1fr]">
        <div className="flex flex-col items-center justify-center gap-2 bg-[#0B0F19] px-3 py-5 text-center text-white">
        ...
        <div className="min-w-0 p-4">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              <p className="truncate text-lg font-black text-[#0B0F19]">
                {voucher.code}
              </p>
          ...
          <div className="mt-3 grid gap-2 text-xs font-semibold text-gray-500 sm:grid-cols-2">
            <span className="inline-flex items-center gap-1.5 rounded-lg bg-[#F1F5F9] px-3 py-2">
          ...
          <div className="mt-4">
            ...
            <div className="h-2 overflow-hidden rounded-full bg-[#F8FAFC]">
              <div
                className={`h-full rounded-full ${eligible ? 'bg-[#1D4ED8]' : 'bg-[#fbbc05]'}`}
          ...
          <div className="mt-4 flex flex-col gap-2 sm:flex-row">
            <button
              ...
              className="client-pill-outline flex min-h-11 flex-1 items-center justify-center gap-2 px-4 py-2.5 text-sm font-black disabled:border-[#2563EB]/20 disabled:bg-[#DBEAFE]/50 disabled:text-[#2563EB]"
            >
              {voucher.isSaved ? (
                <>
