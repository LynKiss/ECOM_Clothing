...
export default function AdminNewOrderToast({ collapsed }: AdminNewOrderToastProps) {
  ...
  return (
    <div
      ...
      aria-live="polite"
    >
      <div className="admin-card overflow-hidden border-[#1D4ED8]/20 bg-white">
        <div className="flex items-start gap-3 border-l-4 border-[#1D4ED8] px-4 py-4">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#0B0F19] text-white">
            <ShoppingCart size={20} />
          </div>
          <div className="min-w-0 flex-1">
            <p className="text-sm font-black text-[#0B0F19]">Co don hang moi</p>
          ...
          <button
            ...
            className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-on-surface-variant transition hover:bg-on-surface/5 hover:text-[#2563EB]"
