...
export default function Payment() {
  ...
  if (success) {
    return (
      <div
        style={{ background: '#F8FAFC', minHeight: '80vh' }}
      ...
      >
        <div className="w-full max-w-md text-center">
          ...
          <h1 className="text-2xl font-black text-[#0B0F19]">
            Đặt hàng thành công!
          </h1>
          <p className="mt-2 text-sm text-gray-500">
            Cảm ơn bạn đã tin tưởng Fashion Ledger. Chúng tôi sẽ xử lý đơn
          ...
          {success.isGuest && (
            <div className="mt-4 rounded-xl border border-amber-200 bg-amber-50 p-4 text-left">
              ...
              <p className="mt-1 text-sm font-black text-[#0B0F19]">Mã đơn: #{success.orderId.slice(0, 8).toUpperCase()}</p>
          ...
          <div className="mt-6 flex gap-3">
            {!success.isGuest && (
              <Link
                ...
                className="flex-1 rounded-full border border-[#2563EB] py-3 text-sm font-bold text-[#2563EB] transition hover:bg-[#2563EB] hover:text-white"
              >
                Xem đơn hàng
              </Link>
            )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
          <div className="client-card w-full max-w-sm overflow-hidden">
            <div
              ...
              style={{ background: selectedMethodInfo?.color ?? '#0B0F19' }}
            >
            ...
            <div className="p-6 text-center">
              ...
              <p className="mt-1 text-xl font-black text-[#0B0F19]">
                {formatPrice(total)}
              </p>
              ...
              <div className="mt-5 space-y-2">
                <button
                  ...
                  style={{ background: selectedMethodInfo?.color ?? '#2563EB' }}
                >
                  {simConfirming ? (
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_340px]">
            <div>
              <h2 className="mb-4 flex items-center gap-2 text-lg font-black text-[#0B0F19]">
                <CreditCard size={20} className="text-[#2563EB]" /> Phương thức
                thanh toán
              </h2>

              {loadingSettings ? (
                <div className="flex justify-center rounded-2xl bg-white py-12">
                  <LoaderCircle size={22} className="animate-spin text-[#2563EB]" />
                </div>
                ...
                <div className="space-y-3">
                    ...
                    <button
                      ...
                      className={`flex w-full items-start gap-4 rounded-2xl border-2 p-4 text-left transition ${
                        method === paymentMethod.id
                          ...
                          : 'border-transparent bg-white hover:border-[#2563EB]/20'
                      }`}
                    >
                  ...
                  {isCreditAvailable && creditLimit && (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p className="font-bold text-[#0B0F19]">Mua nợ (Công nợ khách sỉ)</p>
                        <p className="mt-0.5 text-xs text-gray-500">
              ...
              <div className="mt-4 flex items-start gap-3 rounded-2xl bg-[#DBEAFE] p-4 text-sm text-[#0B0F19]">
                <ShieldCheck
                  size={18}
                  className="mt-0.5 shrink-0 text-[#2563EB]"
                />
              ...
              <div className="mt-4 flex gap-3">
                <Link
                  to="/client/checkout"
                  className="flex items-center gap-2 rounded-full border border-black/10 px-5 py-3 text-sm font-semibold text-gray-500 hover:text-[#2563EB]"
                >
              ...
              <div className="rounded-2xl bg-white p-5 shadow-sm">
                ...
                <div className="mt-4 space-y-2 border-t border-black/5 pt-4 text-sm">
                  ...
                  <div className="flex justify-between border-t border-black/5 pt-2 text-base font-black">
                    <span className="text-[#0B0F19]">Tổng cộng</span>
