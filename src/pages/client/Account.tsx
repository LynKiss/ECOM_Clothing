    ...
    <div className="client-surface min-h-[80vh]">
      <div className="mx-auto max-w-5xl px-4 py-10 lg:px-6">
        <div className="mb-8">
          ...
          <h1 className="mt-1 text-3xl font-black text-[#0B0F19]">Tài khoản của tôi</h1>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[240px_1fr]">
          ...
          <div className="client-card p-6">
            {activeTab === 'profile' ? (
              <>
                <h2 className="mb-5 text-lg font-black text-[#0B0F19]">Thông tin cá nhân</h2>
              ...
              <>
                <h2 className="mb-5 text-lg font-black text-[#0B0F19]">Đổi mật khẩu</h2>
