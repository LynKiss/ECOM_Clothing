...
import { Heart, Shirt, ShoppingCart, Trash2, ArrowRight } from 'lucide-react';
      ...
      <div className="mx-auto max-w-5xl px-4 py-10 lg:px-6">
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <h1 className="mt-1 flex items-center gap-2.5 text-3xl font-black text-[#0B0F19]">
        ...
        {items.length === 0 ? (
          <div className="client-card flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="font-black text-[#0B0F19]">Chưa có sản phẩm yêu thích</h2>
              ...
              {items.map(({ productId, product }) => {
                ...
                return (
                  ...
                  >
                      ...
                      <div className="overflow-hidden bg-[#F8FAFC]">
                        {product.primaryImageUrl ? (
                          ...
                          <div className="flex h-44 items-center justify-center">
                            <Shirt size={40} className="text-[#2563EB]/20" />
                          </div>
                        )}
                      </div>
                    </Link>
                    ...
                    <div className="p-4">
                      {product.category && (
                        <p className="mb-1 text-[10px] font-bold uppercase tracking-wider text-[#2563EB]">
                          {product.category.categoryName}
                        </p>
                      )}
                      <Link to={`/client/products/${productId}`}>
                        <p className="line-clamp-2 text-sm font-bold leading-snug text-[#0B0F19] hover:text-[#2563EB]">
                          {product.productName}
                        </p>
                      </Link>
                      ...
                      <div className="mt-3 flex gap-2">
                        ...
                        <Link
                          ...
                          className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-black/10 text-gray-400 transition hover:border-[#2563EB] hover:text-[#2563EB]"
                        >
                          <ArrowRight size={13} />
                        </Link>
                      </div>
