    ...
    return (
      <div className="client-surface flex min-h-[60vh] items-center justify-center">
        <div className="text-center">
          <ShoppingCart size={48} className="mx-auto mb-4 text-[#2563EB]/30" />
      ...
      <div className="mx-auto max-w-6xl px-4 py-10 lg:px-6">
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 className="mt-1 text-3xl font-black text-[#0B0F19]">
              Giỏ hàng
            </h1>
          </div>
          <Link
        ...
        {loading ? (
          ...
          <div className="client-card flex flex-col items-center justify-center py-20 text-center">
            <ShoppingCart size={56} className="mb-4 text-[#2563EB]/20" />
            <h2 className="text-xl font-black text-[#0B0F19]">
              Giỏ hàng trống
            </h2>
            <p className="mt-2 text-sm text-gray-500">
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_390px]">
            <div className="space-y-3">
              {cart.items.map((item) => (
                ...
                >
                  <Link
                    ...
                    className="h-20 w-20 shrink-0 overflow-hidden rounded-2xl bg-[#F8FAFC]"
                  >
                    {item.primaryImageUrl ? (
                      ...
                      <div className="flex h-full items-center justify-center">
                        <Shirt size={24} className="text-[#2563EB]/20" />
                      </div>
                    )}
                  </Link>
                  ...
                  <div className="min-w-0 flex-1">
                    <Link
                      to={`/client/products/${item.productId}`}
                      className="line-clamp-2 text-sm font-bold text-[#0B0F19] hover:text-[#2563EB]"
                    >
                      {item.productName}
                    </Link>
                    ...
                    <div className="mt-3 flex items-center justify-between gap-3">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="flex h-8 w-8 items-center justify-center rounded-full border border-black/10 transition hover:border-[#2563EB] disabled:opacity-40"
                        >
                          <Minus size={13} />
                        </button>
                        <input
                          ...
                          className="w-10 border-0 bg-transparent text-center text-sm font-bold text-[#0B0F19] outline-none [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                        />
                        <button
                          onClick={() =>
                            void handleQuantityChange(item.id, item.quantity + 1)
              ...
              <Link
                to="/client/products"
                className="flex items-center gap-2 rounded-xl border-2 border-dashed border-[#2563EB]/20 bg-white px-5 py-4 text-sm font-semibold text-[#2563EB] transition hover:border-[#2563EB]/40"
              >
                <Shirt size={16} /> Tiếp tục mua sắm
              </Link>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="client-card p-5">
                ...
                {discountResult ? (
                  <div className="rounded-xl border border-[#2563EB]/15 bg-[#DBEAFE]/45 p-4">
      ...
      <div className="flex gap-3 p-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-2">
            ...
            <span className="rounded-full bg-[#DBEAFE] px-2 py-1 text-xs font-black text-[#2563EB]">
