...
const supportPages: Record<string, SupportConfig> = {
  'buying-guide': {
    ...
    eyebrow: 'Mua sắm',
    intro:
      'Từ chọn size, nhận voucher đến theo dõi đơn hàng, quy trình được thiết kế để bạn đặt đúng sản phẩm và kiểm soát chi phí trước khi thanh toán.',
    icon: ShoppingBag,
  ...
  warranty: {
    ...
    eyebrow: 'Cam kết',
    intro:
      'Bảo hành áp dụng theo tiêu chuẩn nhà sản xuất và điều kiện sử dụng thực tế của từng nhóm sản phẩm thời trang, phụ kiện.',
    icon: ShieldCheck,
    ...
    steps: [
      {
        ...
        description:
          'Quần áo, giày túi và phụ kiện có quy định bảo hành khác nhau theo thương hiệu hoặc nhà phân phối.',
      },
      {
  ...
  'news-knowledge': {
    ...
    eyebrow: 'Phong cách hôm nay',
    intro:
      'Tổng hợp xu hướng thời trang, mẹo chọn size, cách phối đồ và kinh nghiệm chăm sóc chất liệu.',
    icon: Newspaper,
    ...
    steps: [
      {
        ...
        description:
          'Các bài viết về chọn chất liệu, phối màu, form dáng và xu hướng theo mùa.',
      },
      {
        title: 'Hướng dẫn chọn và bảo quản trang phục',
        description:
      ...
      },
      {
        ...
        description:
          'Theo dõi xu hướng giá, bộ sưu tập mới và thông tin hữu ích trước khi mua sắm.',
      },
      {
    ...
    notes: [
      ...
      'Có thể dùng AI tư vấn phối đồ khi cần chọn size hoặc phối outfit nhanh.',
    ],
  },
  contact: {
    ...
    intro:
      'Kết nối với đội ngũ Fashion Ledger để được tư vấn đơn hàng, voucher, đổi trả, bảo hành và phối đồ.',
    icon: Headphones,
    primaryCta: 'Mở chat hỗ trợ',
    onPrimaryClick: openSupportChat,
    steps: [
      ...
      {
        title: 'Email',
        description: 'support@fashionledger.vn cho yêu cầu cần gửi hình ảnh, hóa đơn hoặc hồ sơ chi tiết.',
      },
      {
        title: 'Địa chỉ',
        description: '123 Fashion Street, Quận 1, TP.HCM.',
      },
      {
        title: 'Chat hỗ trợ',
...
export default function SupportLanding() {
  ...
  return (
    <div className="client-surface min-h-[80vh]">
      <section style={{ background: '#0B0F19' }} className="text-white">
        <div className="mx-auto grid max-w-7xl gap-8 px-6 py-14 md:grid-cols-[1.1fr_0.9fr] md:items-center">
          <div>
            ...
            {config.primaryHref ? (
              <Link
                ...
                className="mt-7 inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-black text-[#1D4ED8] transition active:scale-95"
              >
          ...
          <div className="rounded-xl border border-white/10 bg-white/8 p-6">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#1D4ED8]">
              <Icon size={30} />
            </div>
            <div className="mt-6 grid gap-3 text-sm text-white/72">
              <p className="flex items-center gap-2">
                <CheckCircle2 size={16} className="text-[#DBEAFE]" />
                Hỗ trợ 7:00 - 21:00 mỗi ngày
              </p>
              <p className="flex items-center gap-2">
                <Mail size={16} className="text-[#DBEAFE]" />
                support@fashionledger.vn
              </p>
              <p className="flex items-center gap-2">
                <MapPin size={16} className="text-[#DBEAFE]" />
                Giao hàng toàn quốc
              </p>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-12">
        <div className="grid gap-4 md:grid-cols-2">
          {config.steps.map((step, index) => (
            <article key={step.title} className="client-card p-6">
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-[#DBEAFE] text-sm font-black text-[#2563EB]">
                {index + 1}
              </div>
        ...
        <div className="mt-8 rounded-xl bg-[#F1F5F9] p-6">
          <h2 className="flex items-center gap-2 text-lg font-black text-[#0B0F19]">
            <PackageCheck size={20} className="text-[#2563EB]" />
            Lưu ý quan trọng
          </h2>
